package com.creswave.blog.account.username.update;
 ...
 */
public class UpdateUsernameIT {

    private void updateUsername( Long userId, String username, String standardUserToken ) {
    ...
    void updatePassword() throws URISyntaxException {
        ...
        updateUsername( userId, username, standardUserToken );
    }
}
