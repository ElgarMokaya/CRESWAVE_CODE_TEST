...
public class CreatePostValidatorImpl implements CreatePostValidator {
    ...
    @Override
    public HttpStatus validate( CreatePostResponseBuilder builder, String title, String text ) {
