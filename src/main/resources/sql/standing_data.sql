...
VALUES(1, current_timestamp, current_timestamp, 'Roles the Standard User has', 
'Standard User Role Group');
...
VALUES(1, current_timestamp, current_timestamp, 'Permission to add Comments', 'STANDARD_USER');
